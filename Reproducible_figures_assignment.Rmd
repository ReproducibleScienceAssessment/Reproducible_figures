...
We are going to use a linear regression and qqplot to see if the data is normally distributed and has a linear relationship. This allows us to test the assumptions of the Pearson correlation coefficient test.
