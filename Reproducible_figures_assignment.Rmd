...
#Now chinstrap_data#Now we are going to generate an exploratory plot to show the distribution of the data 
...
H0 = *there is no relationship between the culmen length and depth of Chinstrap penguins' bills*

HA = *there is a correlation between the culmen length and depth of Chinstrap penguins' bills*
